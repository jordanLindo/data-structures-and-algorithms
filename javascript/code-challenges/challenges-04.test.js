...
const sortPeople = (arr) => {
  ...
  return (arr.sort((val1, val2) => {
    ...
    if (val1.lastName > val2.lastName) {
      result = 1;
    } else if (val1.lastName < val2.lastName) {
      result = -1;
    }
    return result;
  }));
...
const sortPeopleBetter = (arr) => (arr.sort((val1, val2) => val1.lastName > val2.lastName ? 1 : val1.lastName < val2.lastName ? -1 : val1.firstName > val2.firstName ? 1 : val1.firstName < val2.firstName ? -1 : val1.age > val2.age ? 1 : val1.age < val2.age ? -1 : 0));
/*
// Solution code here...
  {
  return (arr.sort((val1, val2) => {
    ...
    if (val1.lastName > val2.lastName) {
      ...
      if (val1.firstName > val2.firstName) {
        result = 1;
      } else if (val1.firstName < val2.firstName) {
        result = -1;
      } else if (val1.firstName === val2.firstName) {
        if (val1.age > val2.age) {
          result = 1;
        } else if (val1.age < val2.age) {
          result = -1;
        } else if (val1.age === val2.age) {
          result = 0;
        }
...
const sortSchedule = (arr) => arr.sort((val1, val2) => val1.dayOfWeek === 'Monday' ? val2.dayOfWeek === 'Monday' ? val1.start === val2.start ? val1.end < val2.end ? 1 : -1 : val1.start > val2.start ? 1 : -1 : 1 : val1.dayOfWeek === 'Tuesday' ? val2.dayOfWeek === 'Monday' ? -1 : val2.dayOfWeek === 'Tuesday' ? val1.start === val2.start ? val1.end < val2.end ? 1 : -1 : val1.start > val2.start ? 1 : -1 : 1 : val1.dayOfWeek === 'Wednesday' ? val2.dayOfWeek === 'Monday' ? -1 : val2.dayOfWeek === 'Tuesday' ? -1 : val2.dayOfWeek === 'Wednesday' ? val1.start === val2.start ? val1.end < val2.end ? 1 : -1 : val1.start > val2.start ? 1 : -1 : 1 : val1.dayOfWeek === 'Thursday' ? val2.dayOfWeek === 'Monday' ? -1 : val2.dayOfWeek === 'Tuesday' ? -1 : val2.dayOfWeek === 'Wednesday' ? -1 : val2.dayOfWeek === 'Thursday' ? val1.start === val2.start ? val1.end < val2.end ? 1 : -1 : val1.start > val2.start ? 1 : -1 : 1 : val1.dayOfWeek === 'Friday' ? val2.dayOfWeek === 'Friday' ? val1.start === val2.start ? val1.end < val2.end ? 1 : -1 : val1.start > val2.start ? 1 : -1 : 1 : 0);
  ...
  return (arr.sort((val1, val2) => {
    ...
    if(firstVal > secondVal){
      ...
      if(val1.start > val2.start){
        ...
        let len1 = val1.end - val1.start;
        let len2 = val2.end - val2.start;
        if(len1 > len2){
          result = 1;
        } else if(len1 < len2){
          result = -1;
